...
for subjNo = 67:subjNoAll
    ...
    subjIdx = find(ismember(raw(:,2),dinfo(subjNo).name));
...
% behInfo(3) = [];
save([saveDataPath,'behInfo_ifado_2ndRound'],'behInfo');

%%
saveDataPath = 'F:\project\navigationParadigm\MorrisMaze\analyzeBehData\';
load([saveDataPath,'behInfo_ifado_2ndRound'])
...
save([saveDataPath,'behInfo_ifado_v2_2ndRound'],'behInfo','-v7.3');
